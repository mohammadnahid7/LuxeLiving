		...
		<div className="h-screen bg-secondary">
			<div className="container mx-auto max-w-7xl py-20 w-full h-full flex justify-start items-end">
				<div className="hero-left w-1/2 pr-5">
					<div className="badge badge-neutral text-lg py-4 px-5">Furniture Design Ideas</div>
					...
					<div className="mt-12">
						...
						<button className="btn btn-link text-xl text-white">Follow Instagram</button>
					</div>
				...
				<div className="hero-right pl-20 grid grid-cols-3 gap-6">
					<figure className="col-span-2 rounded-2xl relative">
						<img src="./assets/bedroom.jpg" alt="" className="w-full h-[600px] rounded-2xl" />
					...
					<figure className="col-span-1 rounded-2xl relative">
						<img src="./assets/livingroom.jpg" alt="" className="w-full h-[600px] rounded-2xl" />
						<div className="-rotate-90 origin-bottom-left text-white flex justify-center items-end p-6 w-[600px] h-32 absolute bottom-0 left-full rounded-b-2xl bg-gradient-to-t from-[#000000aa] from-60% to-transparent">
