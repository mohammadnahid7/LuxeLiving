...
const Hero = () => {
	...
	return (
		<header
			className={`${isHomepage ? "h-screen" : "min-h-96 h-[40vh]"} bg-secondary`}
			style={
				isHomepage
					? {}
					: {
				...
				<div className="container mx-auto max-w-7xl py-20 w-full h-full flex justify-start items-end">
					<div className="hero-left w-1/2 pr-5">
						...
						<p className="text-xl text-base-300 mt-4">
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta reiciendis repudiandae animi aut
							voluptatem fugiat aspernatur suscipit unde quidem, vitae earum at est eos, veritatis rerum beatae
							maiores libero nobis.
						</p>
						<div className="mt-12">
			...
			{!isHomepage && (
				<div className="container mx-auto max-w-7xl py-28 w-full h-full flex justify-start items-end px-20">
